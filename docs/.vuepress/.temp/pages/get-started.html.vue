<template><div><h1 id="提问的智慧" tabindex="-1"><a class="header-anchor" href="#提问的智慧"><span>提问的智慧</span></a></h1>
<p><a href="https://github.com/ryanhanwu/How-To-Ask-Questions-The-Smart-Way/pulls" target="_blank" rel="noopener noreferrer"><img src="https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square" alt="PRs Welcome"></a></p>
...
<p>本文另有<RouteLink to="/">繁體中文版</RouteLink>。</p>
<h2 id="原文版本历史" tabindex="-1"><a class="header-anchor" href="#原文版本历史"><span><RouteLink to="/history.html">原文版本历史</RouteLink></span></a></h2>
...
<li><a href="#%E5%8D%B3%E4%BD%BF%E4%BD%A0%E5%BE%88%E6%80%A5%E4%B9%9F%E4%B8%8D%E8%A6%81%E5%9C%A8%E6%A0%87%E9%A2%98%E5%86%99%E7%B4%A7%E6%80%A5">即使你很急也不要在标题写<code v-pre>紧急</code></a></li>
...
<p>我们不讳言我们对那些不愿思考、或者在发问前不做他们该做的事的人的蔑视。那些人是时间杀手 —— 他们只想索取，从不付出，消耗我们可用在更有趣的问题或更值得回答的人身上的时间。我们称这样的人为 <code v-pre>失败者（loser）</code> （由于历史原因，我们有时把它拼作 <code v-pre>lusers</code>）。</p>
...
<p>我们（在很大程度上）是自愿的，从繁忙的生活中抽出时间来解答疑惑，而且时常被提问淹没。所以我们无情地滤掉一些话题，特别是拋弃那些看起来像失败者的家伙，以便更高效地利用时间来回答<code v-pre>赢家（winner）</code>的问题。</p>
...
<h2 id="在提问之前" tabindex="-1"><a class="header-anchor" href="#在提问之前"><span>在提问之前</span></a></h2>
...
<p>运用某些策略，比如先用 Google 搜索你所遇到的各种错误信息（搜索 <a href="http://groups.google.com/" target="_blank" rel="noopener noreferrer">Google 论坛</a>和网页），这样很可能直接就找到了能解决问题的文件或邮件列表线索。即使没有结果，在邮件列表或新闻组寻求帮助时加上一句 <code v-pre>我在 Google 中搜过下列句子但没有找到什么有用的东西</code> 也是件好事，即使它只是表明了搜索引擎不能提供哪些帮助。这么做（加上搜索过的字串）也让遇到相似问题的其他人能被搜索引擎引导到你的提问来。</p>
...
<p>小心别问错了问题。如果你的问题基于错误的假设，某个普通黑客（J. Random Hacker）多半会一边在心里想着<code v-pre>蠢问题…</code>，一边用无意义的字面解释来答复你，希望着你会从问题的回答（而非你想得到的答案）中汲取教训。</p>
...
<p>另一方面，表明你愿意在找答案的过程中做点什么是一个非常好的开端。<code v-pre>谁能给点提示？</code>、<code v-pre>我的这个例子里缺了什么？</code>以及<code v-pre>我应该检查什么地方</code>比<code v-pre>请把我需要的确切的过程贴出来</code>更容易得到答复。因为你表现出只要有人能指个正确方向，你就有完成它的能力和决心。</p>
<h2 id="当你提问时" tabindex="-1"><a class="header-anchor" href="#当你提问时"><span>当你提问时</span></a></h2>
<h3 id="慎选提问的论坛" tabindex="-1"><a class="header-anchor" href="#慎选提问的论坛"><span>慎选提问的论坛</span></a></h3>
...
<h3 id="stack-overflow" tabindex="-1"><a class="header-anchor" href="#stack-overflow"><span>Stack Overflow</span></a></h3>
...
<h3 id="网站和-irc-论坛" tabindex="-1"><a class="header-anchor" href="#网站和-irc-论坛"><span>网站和 IRC 论坛</span></a></h3>
...
<h3 id="第二步-使用项目邮件列表" tabindex="-1"><a class="header-anchor" href="#第二步-使用项目邮件列表"><span>第二步，使用项目邮件列表</span></a></h3>
...
<h3 id="使用有意义且描述明确的标题" tabindex="-1"><a class="header-anchor" href="#使用有意义且描述明确的标题"><span>使用有意义且描述明确的标题</span></a></h3>
<p>在邮件列表、新闻群组或论坛中，大约 50 字以内的标题是抓住资深专家注意力的好机会。别用喋喋不休的<code v-pre>帮帮忙</code>、<code v-pre>跪求</code>、<code v-pre>急</code>（更别说<code v-pre>救命啊！！！！</code>这样让人反感的话，用这种标题会被条件反射式地忽略）来浪费这个机会。不要妄想用你的痛苦程度来打动我们，而应该是在这点空间中使用极简单扼要的描述方式来提出问题。</p>
<p>一个好标题范例是<code v-pre>目标 —— 差异</code>式的描述，许多技术支持组织就是这样做的。在<code v-pre>目标</code>部分指出是哪一个或哪一组东西有问题，在<code v-pre>差异</code>部分则描述与期望的行为不一致的地方。</p>
<blockquote>
...
<p>编写<code v-pre>目标 —— 差异</code> 式描述的过程有助于你组织对问题的细致思考。是什么被影响了？ 仅仅是鼠标指针或者还有其它图形？只在 X.org 的 X 版中出现？或只是出现在 6.8.1 版中？ 是针对某牌显卡芯片组？或者只是其中的 MV1005 型号？ 一个黑客只需瞄一眼就能够立即明白你的环境<strong>和</strong>你遇到的问题。</p>
<p>总而言之，请想像一下你正在一个只显示标题的存档讨论串（Thread）索引中查寻。让你的标题更好地反映问题，可使下一个搜索类似问题的人能够关注这个讨论串，而不用再次提问相同的问题。</p>
<p>如果你想在回复中提出问题，记得要修改内容标题，以表明你是在问一个问题， 一个看起来像 <code v-pre>Re: 测试</code> 或者 <code v-pre>Re: 新 bug</code> 的标题很难引起足够重视。另外，在不影响连贯性之下，适当引用并删减前文的内容，能给新来的读者留下线索。</p>
...
<h3 id="使问题容易回复" tabindex="-1"><a class="header-anchor" href="#使问题容易回复"><span>使问题容易回复</span></a></h3>
<p>以<code v-pre>请将你的回复发送到……</code>来结束你的问题多半会使你得不到回答。如果你觉得花几秒钟在邮件客户端设置一下回复地址都麻烦，我们也觉得花几秒钟思考你的问题更麻烦。如果你的邮件程序不支持这样做，<a href="http://linuxmafia.com/faq/Mail/muas.html" target="_blank" rel="noopener noreferrer">换个好点的</a>；如果是操作系统不支持这种邮件程序，也换个好点的。</p>
<p>在论坛，要求通过电子邮件回复是非常无礼的，除非你认为回复的信息可能比较敏感（有人会为了某些未知的原因，只让你而不是整个论坛知道答案）。如果你只是想在有人回复讨论串时得到电子邮件提醒，可以要求网页论坛发送给你。几乎所有论坛都支持诸如<code v-pre>追踪此讨论串</code>、<code v-pre>有回复时发送邮件提醒</code>等功能。</p>
<h3 id="使用清晰、正确、精准且合乎语法的语句" tabindex="-1"><a class="header-anchor" href="#使用清晰、正确、精准且合乎语法的语句"><span>使用清晰、正确、精准且合乎语法的语句</span></a></h3>
...
<p>正确地拼写、使用标点和大小写，不要将<code v-pre>its</code>混淆为<code v-pre>it's</code>，<code v-pre>loose</code>搞成<code v-pre>lose</code>或者将<code v-pre>discrete</code>弄成<code v-pre>discreet</code>。不要<strong>全部用大写</strong>，这会被视为无礼的大声嚷嚷（全部小写也好不到哪去，因为不易阅读。<a href="http://en.wikipedia.org/wiki/Alan_Cox" target="_blank" rel="noopener noreferrer">Alan Cox</a> 也许可以这样做，但你不行）。</p>
<p>更白话的说，如果你写得像是个半文盲[译注：<a href="http://zh.wikipedia.org/wiki/%E5%B0%8F%E7%99%BD" target="_blank" rel="noopener noreferrer">小白</a>]，那多半得不到理睬。也不要使用即时通信中的简写或<a href="http://zh.wikipedia.org/wiki/%E7%81%AB%E6%98%9F%E6%96%87" target="_blank" rel="noopener noreferrer">火星文</a>，如将<code v-pre>的</code>简化为<code v-pre>d</code>会使你看起来像一个为了少打几个键而省字的小白。更糟的是，如果像个小孩似地鬼画符那绝对是在找死，可以肯定没人会理你（或者最多是给你一大堆指责与挖苦）。</p>
...
<h3 id="使用易于读取且标准的文件格式发送问题" tabindex="-1"><a class="header-anchor" href="#使用易于读取且标准的文件格式发送问题"><span>使用易于读取且标准的文件格式发送问题</span></a></h3>
...
<li>在英语论坛中，不要使用<code v-pre>Quoted-Printable</code> MIME 编码发送消息。这种编码对于张贴非 ASCII 语言可能是必须的，但很多邮件程序并不支持这种编码。当它们处理换行时，那些文本中四处散布的<code v-pre>=20</code>符号既难看也分散注意力，甚至有可能破坏内容的语意。</li>
...
<li>如果你从使用 Windows 的电脑发送电子邮件，关闭微软愚蠢的<code v-pre>智能引号</code>功能 （从[选项] &gt; [校订] &gt; [自动校正选项]，勾选掉<code v-pre>智能引号</code>单选框），以免在你的邮件中到处散布垃圾字符。</li>
<li>在论坛，勿滥用<code v-pre>表情符号</code>和<code v-pre>HTML</code>功能（当它们提供时）。一两个表情符号通常没有问题，但花哨的彩色文本倾向于使人认为你是个无能之辈。过滥地使用表情符号、色彩和字体会使你看来像个傻笑的小姑娘。这通常不是个好主意，除非你只是对性而不是对答案感兴趣。</li>
</ul>
<p>如果你使用图形用户界面的邮件程序（如微软公司的 Outlook 或者其它类似的），注意它们的默认设置不一定满足这些要求。大多数这类程序有基于选单的<code v-pre>查看源代码</code>命令，用它来检查发送文件夹中的邮件，以确保发送的是纯文本文件同时没有一些奇怪的字符。</p>
<h3 id="精确地描述问题并言之有物" tabindex="-1"><a class="header-anchor" href="#精确地描述问题并言之有物"><span>精确地描述问题并言之有物</span></a></h3>
<ul>
<li>仔细、清楚地描述你的问题或 Bug 的症状。</li>
<li>描述问题发生的环境（机器配置、操作系统、应用程序、以及相关的信息），提供经销商的发行版和版本号（如：<code v-pre>Fedora Core 4</code>、<code v-pre>Slackware 9.1</code>等）。</li>
<li>描述在提问前你是怎样去研究和理解这个问题的。</li>
<li>描述在提问前为确定问题而采取的诊断步骤。</li>
<li>描述最近做过什么可能相关的硬件或软件变更。</li>
<li>尽可能地提供一个可以<code v-pre>重现这个问题的可控环境</code>的方法。</li>
</ul>
...
<h3 id="话不在多而在精" tabindex="-1"><a class="header-anchor" href="#话不在多而在精"><span>话不在多而在精</span></a></h3>
...
<h3 id="别动辄声称找到-bug" tabindex="-1"><a class="header-anchor" href="#别动辄声称找到-bug"><span>别动辄声称找到 Bug</span></a></h3>
<p>当你在使用软件中遇到问题，除非你非常、<strong>非常</strong>的有根据，不要动辄声称找到了 Bug。提示：除非你能提供解决问题的源代码补丁，或者提供回归测试来表明前一版本中行为不正确，否则你都多半不够完全确信。这同样适用在网页和文件，如果你（声称）发现了文件的<code v-pre>Bug</code>，你应该能提供相应位置的修正或替代文件。</p>
...
<p>编写软件的人总是非常辛苦地使它尽可能完美。如果你声称找到了 Bug，也就是在质疑他们的能力，即使你是对的，也有可能会冒犯到其中某部分人。当你在标题中嚷嚷着有<code v-pre>Bug</code>时，这尤其严重。</p>
...
<h3 id="低声下气不能代替你的功课" tabindex="-1"><a class="header-anchor" href="#低声下气不能代替你的功课"><span>低声下气不能代替你的功课</span></a></h3>
<p>有些人明白他们不该粗鲁或傲慢的提问并要求得到答复，但他们选择另一个极端 —— 低声下气：<code v-pre>我知道我只是个可悲的新手，一个失败者，但...</code>。这既使人困扰，也没有用，尤其是伴随着与实际问题含糊不清的描述时更令人反感。</p>
...
<h3 id="描述问题症状而非你的猜测" tabindex="-1"><a class="header-anchor" href="#描述问题症状而非你的猜测"><span>描述问题症状而非你的猜测</span></a></h3>
...
<p>由于以上这点似乎让许多人觉得难以配合，这里有句话可以提醒你：<code v-pre>所有的诊断专家都来自密苏里州。</code> 美国国务院的官方座右铭则是：<code v-pre>让我看看</code>（出自国会议员 Willard D. Vandiver 在 1899 年时的讲话：<code v-pre>我来自一个出产玉米，棉花，牛蒡和民主党人的国家，滔滔雄辩既不能说服我，也不会让我满意。我来自密苏里州，你必须让我看看。</code>） 针对诊断者而言，这并不是一种怀疑，而只是一种真实而有用的需求，以便让他们看到的是与你看到的原始证据尽可能一致的东西，而不是你的猜测与归纳的结论。所以，大方地展示给我们看吧！</p>
<h3 id="按发生时间先后列出问题症状" tabindex="-1"><a class="header-anchor" href="#按发生时间先后列出问题症状"><span>按发生时间先后列出问题症状</span></a></h3>
...
<p>如果挂掉的程序有诊断选项（如 -v 的详述开关），试着选择这些能在记录中增加调试信息的选项。记住，<code v-pre>多</code>不等于<code v-pre>好</code>。试着选取适当的调试级别以便提供有用的信息而不是让读者淹没在垃圾中。</p>
<p>如果你的说明很长（如超过四个段落），在开头简述问题，接下来再按时间顺序详述会有所帮助。这样黑客们在读你的记录时就知道该注意哪些内容了。</p>
<h3 id="描述目标而不是过程" tabindex="-1"><a class="header-anchor" href="#描述目标而不是过程"><span>描述目标而不是过程</span></a></h3>
...
<p>第二种提问法比较聪明，你可能得到像是<code v-pre>建议采用另一个更合适的工具</code>的回复。</p>
<h3 id="别要求使用私人电邮回复" tabindex="-1"><a class="header-anchor" href="#别要求使用私人电邮回复"><span>别要求使用私人电邮回复</span></a></h3>
...
<p>这条规则存在一条有限的例外，如果你确信提问可能会引来大量雷同的回复时，那么这个神奇的提问句会是<code v-pre>向我发电邮，我将为论坛归纳这些回复</code>。试着将邮件列表或新闻群组从洪水般的雷同回复中解救出来是非常有礼貌的 —— 但你必须信守诺言。</p>
<h3 id="清楚明确地表达你的问题以及需求" tabindex="-1"><a class="header-anchor" href="#清楚明确地表达你的问题以及需求"><span>清楚明确地表达你的问题以及需求</span></a></h3>
...
<p>所以，界定一下你的问题，使专家花在辨识你的问题和回答所需要付出的时间减到最少，这技巧对你获得有用的答案相当有帮助 —— 但这技巧通常和简化问题有所区别。因此，问<code v-pre>我想更好地理解 X，可否指点一下哪有好一点说明？</code>通常比问<code v-pre>你能解释一下 X 吗？</code>更好。如果你的代码不能运作，通常请别人看看哪里有问题，比要求别人替你改正要明智得多。</p>
<h3 id="询问有关代码的问题时" tabindex="-1"><a class="header-anchor" href="#询问有关代码的问题时"><span>询问有关代码的问题时</span></a></h3>
<p>如果没有提示别人应该从何入手，别要求他人帮你调试有问题的代码。张贴几百行的代码，然后说一声：<code v-pre>它不能工作</code>会让你完全被忽略。只贴几十行代码，然后说一句：<code v-pre>在第七行以后，我期待它显示 &lt;x&gt;，但实际出现的是 &lt;y&gt;</code>比较有可能让你得到回应。</p>
...
<h3 id="别把自己家庭作业的问题贴上来" tabindex="-1"><a class="header-anchor" href="#别把自己家庭作业的问题贴上来"><span>别把自己家庭作业的问题贴上来</span></a></h3>
...
<h3 id="去掉无意义的提问句" tabindex="-1"><a class="header-anchor" href="#去掉无意义的提问句"><span>去掉无意义的提问句</span></a></h3>
<p>避免用无意义的话结束提问，例如<code v-pre>有人能帮我吗？</code>或者<code v-pre>这有答案吗？</code>。</p>
<p>首先：如果你对问题的描述不是很好，这样问更是画蛇添足。</p>
<p>其次：由于这样问是画蛇添足，黑客们会很厌烦你 —— 而且通常会用逻辑上正确，但毫无意义的回答来表示他们的蔑视， 例如：<code v-pre>没错，有人能帮你</code>或者<code v-pre>不，没答案</code>。</p>
<p>一般来说，避免用 <code v-pre>是或否</code>、<code v-pre>对或错</code>、<code v-pre>有或没有</code>类型的问句，除非你想得到<a href="https://strcat.de/questions-with-yes-or-no-answers.html" target="_blank" rel="noopener noreferrer">是或否类型的回答</a>。</p>
<h3 id="即使你很急也不要在标题写紧急" tabindex="-1"><a class="header-anchor" href="#即使你很急也不要在标题写紧急"><span>即使你很急也不要在标题写<code v-pre>紧急</code></span></a></h3>
<p>这是你的问题，不是我们的。宣称<code v-pre>紧急</code>极有可能事与愿违：大多数黑客会直接删除无礼和自私地企图即时引起关注的问题。更严重的是，<code v-pre>紧急</code>这个字（或是其他企图引起关注的标题）通常会被垃圾信过滤器过滤掉 —— 你希望能看到你问题的人可能永远也看不到。</p>
<p>有半个例外的情况是，如果你是在一些很高调，会使黑客们兴奋的地方，也许值得这样去做。在这种情况下，如果你有时间压力，也很有礼貌地提到这点，人们也许会有兴趣回答快一点。</p>
<p>当然，这风险很大，因为黑客们兴奋的点多半与你的不同。譬如从 NASA 国际空间站（International Space Station）发这样的标题没有问题，但用自我感觉良好的慈善行为或政治原因发肯定不行。事实上，张贴诸如<code v-pre>紧急：帮我救救这个毛茸茸的小海豹！</code>肯定让你被黑客忽略或惹恼他们，即使他们认为毛茸茸的小海豹很重要。</p>
<p>如果你觉得这点很不可思议，最好再把这份指南剩下的内容多读几遍，直到你弄懂了再发文。</p>
<h3 id="礼多人不怪-而且有时还很有帮助" tabindex="-1"><a class="header-anchor" href="#礼多人不怪-而且有时还很有帮助"><span>礼多人不怪，而且有时还很有帮助</span></a></h3>
<p>彬彬有礼，多用<code v-pre>请</code>和<code v-pre>谢谢您的关注</code>，或<code v-pre>谢谢你的关照</code>。让大家都知道你对他们花时间免费提供帮助心存感激。</p>
...
<p>（我们注意到，自从本指南发布后，从资深黑客那里得到的唯一严重缺陷反馈，就是对预先道谢这一条。一些黑客觉得<code v-pre>先谢了</code>意味着事后就不用再感谢任何人的暗示。我们的建议是要么先说<code v-pre>先谢了</code>，<strong>然后</strong>事后再对回复者表示感谢，或者换种方式表达感激，譬如用<code v-pre>谢谢你的关注</code>或<code v-pre>谢谢你的关照</code>。）</p>
<h3 id="问题解决后-加个简短的补充说明" tabindex="-1"><a class="header-anchor" href="#问题解决后-加个简短的补充说明"><span>问题解决后，加个简短的补充说明</span></a></h3>
<p>问题解决后，向所有帮助过你的人发个说明，让他们知道问题是怎样解决的，并再一次向他们表示感谢。如果问题在新闻组或者邮件列表中引起了广泛关注，应该在那里贴一个说明比较恰当。</p>
<p>最理想的方式是向最初提问的话题回复此消息，并在标题中包含<code v-pre>已修正</code>，<code v-pre>已解决</code>或其它同等含义的明显标记。在人来人往的邮件列表里，一个看见讨论串<code v-pre>问题 X</code>和<code v-pre>问题 X - 已解决</code>的潜在回复者就明白不用再浪费时间了（除非他个人觉得<code v-pre>问题 X</code>有趣），因此可以利用此时间去解决其它问题。</p>
<p>补充说明不必很长或是很深入；简单的一句<code v-pre>你好，原来是网线出了问题！谢谢大家 – Bill</code>比什么也不说要来的好。事实上，除非结论真的很有技术含量，否则简短可爱的小结比长篇大论更好。说明问题是怎样解决的，但大可不必将解决问题的过程复述一遍。</p>
...
<h2 id="如何解读答案" tabindex="-1"><a class="header-anchor" href="#如何解读答案"><span>如何解读答案</span></a></h2>
<p><a id="rtfm"></a></p>
<h3 id="rtfm-和-stfw-如何知道你已完全搞砸了" tabindex="-1"><a class="header-anchor" href="#rtfm-和-stfw-如何知道你已完全搞砸了"><span>RTFM 和 STFW：如何知道你已完全搞砸了</span></a></h3>
<p>有一个古老而神圣的传统：如果你收到<code v-pre>RTFM（Read The Fucking Manual）</code>的回应，回答者认为你<strong>应该去读他妈的手册</strong>。当然，基本上他是对的，你应该去读一读。</p>
<p>RTFM 有一个年轻的亲戚。如果你收到<code v-pre>STFW（Search The Fucking Web）</code>的回应，回答者认为你<strong>应该到他妈的网上搜索</strong>。那人多半也是对的，去搜索一下吧。（更温和一点的说法是 <strong><a href="http://lmgtfy.com/" target="_blank" rel="noopener noreferrer">Google 是你的朋友</a></strong>！）</p>
...
<h3 id="如果还是搞不懂" tabindex="-1"><a class="header-anchor" href="#如果还是搞不懂"><span>如果还是搞不懂</span></a></h3>
<p>如果你看不懂回应，别立刻要求对方解释。像你以前试着自己解决问题时那样（利用手册，FAQ，网络，身边的高手），先试着去搞懂他的回应。如果你真的需要对方解释，记得表现出你已经从中学到了点什么。</p>
<p>比方说，如果我回答你：<code v-pre>看来似乎是 zentry 卡住了；你应该先清除它。</code>，然后，这是一个<strong>很糟的</strong>后续问题回应：<code v-pre>zentry 是什么？</code> <strong>好</strong>的问法应该是这样：<code v-pre>哦~~~我看过说明了但是只有 -z 和 -p 两个参数中提到了 zentries，而且还都没有清楚的解释如何清除它。你是指这两个中的哪一个吗？还是我看漏了什么？</code></p>
<h3 id="处理无礼的回应" tabindex="-1"><a class="header-anchor" href="#处理无礼的回应"><span>处理无礼的回应</span></a></h3>
...
<p>在下一节，我们会谈到另一个问题，当<strong>你</strong>行为不当时所会受到的<code v-pre>冒犯</code>。</p>
<h2 id="如何避免扮演失败者" tabindex="-1"><a class="header-anchor" href="#如何避免扮演失败者"><span>如何避免扮演失败者</span></a></h2>
...
<p>也有其它的黑客论坛，受过高礼节要求的误导，禁止参与者张贴任何对别人帖子挑毛病的消息，并声称<code v-pre>如果你不想帮助用户就闭嘴。</code> 结果造成有想法的参与者纷纷离开，这么做只会使它们沦为毫无意义的唠叨与无用的技术论坛。</p>
...
<h2 id="不该问的问题" tabindex="-1"><a class="header-anchor" href="#不该问的问题"><span>不该问的问题</span></a></h2>
...
<p>回答：就在我找到它的地方啊，白痴 —— 搜索引擎的那一头。天哪！难道还有人不会用 <a href="https://www.google.com" target="_blank" rel="noopener noreferrer">Google</a> 吗？</p>
<p><a id="q2"></a></p>
<blockquote>
<p>问题：我怎样用 X 做 Y？</p>
</blockquote>
...
<p>回答：不能，我只有亲自在你的电脑上动手才能找到毛病。还是去找你当地的 Linux 使用群组者寻求实际的指导吧（你能在<a href="http://www.linux.org/groups/index.html" target="_blank" rel="noopener noreferrer">这儿</a>找到用户群组的清单）。</p>
<p>注意：如果安装问题与某 Linux 的发行版有关，在它的邮件列表、论坛或本地用户群组中提问也许是恰当的。此时，应描述问题的准确细节。在此之前，先用 <code v-pre>Linux</code> 和<strong>所有</strong>被怀疑的硬件作关键词仔细搜索。</p>
<p><a id="q9"></a></p>
<blockquote>
<p>问题：我怎么才能破解 root 帐号/窃取 OP 特权/读别人的邮件呢？</p>
</blockquote>
<p>回答：想要这样做，说明了你是个卑鄙小人；想找个黑客帮你，说明你是个白痴！</p>
<h2 id="好问题与蠢问题" tabindex="-1"><a class="header-anchor" href="#好问题与蠢问题"><span>好问题与蠢问题</span></a></h2>
...
<p>某黑客对这类问题的回答通常是：<code v-pre>好的，还要帮你拍拍背和换尿布吗？</code>，然后按下删除键。</p>
<p><strong>聪明问题</strong>：</p>
<blockquote>
...
<p>在最后一个问题中，注意<code v-pre>告诉我答案</code>和<code v-pre>给我启示，指出我还应该做什么诊断工作</code>之间微妙而又重要的区别。</p>
...
<h2 id="如果得不到回答" tabindex="-1"><a class="header-anchor" href="#如果得不到回答"><span>如果得不到回答</span></a></h2>
...
<h2 id="如何更好地回答问题" tabindex="-1"><a class="header-anchor" href="#如何更好地回答问题"><span>如何更好地回答问题</span></a></h2>
...
<p><strong>正面地回答问题！</strong> 如果这个提问者已经很深入的研究而且也表明已经试过 X 、 Y 、 Z 、 A 、 B 、 C 但没得到结果，回答 <code v-pre>试试看 A 或是 B</code> 或者 <code v-pre>试试 X 、 Y 、 Z 、 A 、 B 、 C</code> 并附上一个链接一点用都没有。</p>
<p><strong>帮助你的社区从问题中学习。</strong> 当回复一个好问题时，问问自己<code v-pre>如何修改相关文件或常见问题文件以免再次解答同样的问题？</code>，接着再向文件维护者发一份补丁。</p>
<p>如果你在研究一番后才作出了回答，<strong>展现你的技巧而不是直接端出结果</strong>。毕竟<code v-pre>授人以鱼不如授人以渔</code>。</p>
...
<h2 id="鸣谢" tabindex="-1"><a class="header-anchor" href="#鸣谢"><span>鸣谢</span></a></h2>
<p>Evelyn Mitchel 贡献了一些愚蠢问题例子并启发了编写<code v-pre>如何更好地回答问题</code>这一节， Mikhail Ramendik 贡献了一些特别有价值的建议和改进。</p>
</div></template>
